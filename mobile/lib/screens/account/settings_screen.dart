          ...
          : ListView(
              ...
              children: [
                DropdownButtonFormField<String>(
                  initialValue: _genre,
                  decoration: const InputDecoration(labelText: 'Default genre'),
                  items: const [
                    'Fiction',
                    'Non-Fiction',
                    'Self-Help',
                    ...
                    'Thriller',
                      ...
                      .toList(),
                  onChanged: (v) => setState(() => _genre = v ?? 'Fiction'),
                ),
                ...
                DropdownButtonFormField<String>(
                  initialValue: _pov,
                  decoration: const InputDecoration(labelText: 'Point of view'),
                  items: const [
                    DropdownMenuItem(value: 'first', child: Text('First person')),
                    DropdownMenuItem(
                        value: 'second', child: Text('Second person')),
                    DropdownMenuItem(value: 'third', child: Text('Third person')),
                  ],
